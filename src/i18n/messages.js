  ...
  es: {
    ...
    checkout: {
      ...
      delivery: {
        ...
        addressText: 'En EE. UU. usamos ZIP, ciudad y estado. Stripe confirma impuestos y pago.',
        address1: 'Dirección',
        address1Placeholder: 'Street address',
        address2: 'Apartamento, suite, etc.',
        address2Placeholder: 'Apt, suite, unit',
        city: 'Ciudad',
        cityPlaceholder: 'City',
        state: 'Estado',
        statePlaceholder: 'State',
        postalCode: 'ZIP code',
        postalCodePlaceholder: 'ZIP',
        fast: 'Llegará rápido',
  ...
  en: {
    ...
    checkout: {
      ...
      delivery: {
        ...
        addressText: 'For U.S. orders we use ZIP, city, and state. Stripe confirms tax and payment.',
        address1: 'Address',
        address1Placeholder: 'Street address',
