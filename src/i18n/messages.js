export const messages = {
  es: {
    ...
    meta: {
      ...
      accountOrderDetail: 'Detalle de compra',
      signIn: 'Entrar',
      signUp: 'Crear cuenta',
    ...
    accountDetail: {
      ...
      back: 'Volver a mis compras',
      loading: 'Cargando compra',
      errorTitle: 'No pudimos cargar esta compra',
      error: 'Verifica el pedido o intenta de nuevo en unos segundos.',
      ...
      shipping: 'Envio',
      paid: 'Total pagado',
      couponDiscount: 'Descuento del cupon',
      noPromotion: 'Sin promocion',
      noCoupon: 'Sin cupon',
      promotionQuantity: 'Pagaste {paid} y recibes {total}: {free} gratis.',
      tracking: 'Rastreo',
      trackingPendingTitle: 'Rastreo pendiente',
      trackingReadyText: 'El codigo ya esta disponible para seguir el envio.'
    },
    catalog: {
    ...
    home: {
      offer: {
        ...
        claim: 'Quiero mi 10%',
        signInClaim: 'Entrar y recibir 10%',
      ...
      offerConfirm: {
        ...
        subtitle: 'Entra para guardar tu cupón y usarlo en tu primera compra.',
        keep: 'Guardar mi 10%',
  ...
  en: {
    ...
    meta: {
      ...
      accountOrderDetail: 'Purchase detail',
      signIn: 'Sign in',
      signUp: 'Sign up',
    ...
    accountDetail: {
      ...
      errorTitle: 'Could not load this purchase',
      error: 'Check the order or try again in a few seconds.',
      ...
      noCoupon: 'No coupon',
      promotionQuantity: 'You paid for {paid} and receive {total}: {free} free.',
      tracking: 'Tracking',
      trackingPendingTitle: 'Tracking pending',
      trackingReadyText: 'The code is available to follow the shipment.'
    },
    catalog: {
    ...
    home: {
      offer: {
        ...
        claim: 'Claim my 10%',
        signInClaim: 'Sign in and get 10%',
      ...
      offerConfirm: {
        ...
        subtitle: 'Sign in to save your coupon and use it on your first order.',
        keep: 'Keep my 10%',
