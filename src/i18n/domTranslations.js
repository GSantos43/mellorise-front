const staticTextMap = new Map(Object.entries({
  ...
  'cuando estén verificadas': 'once verified',
  ...
  'Ejemplo editable: nos gustó que la rutina fuera simple de explicar y que la información estuviera reunida en un solo lugar.': 'Editable example: we liked that the routine was simple to explain and that the information was gathered in one place.',
  'Ejemplo editable: el formato gummy hizo que la rutina diaria se sintiera más práctica que manejar varios frascos separados.': 'Editable example: the gummy format made the daily routine feel more practical than managing several separate bottles.',
  'Ejemplo editable: la página responde las dudas principales antes de comprar y deja claro cómo revisar ingredientes y uso.': 'Editable example: the page answers the main questions before buying and makes it clear how to review ingredients and use.',
  ...
  'Una rutina mas facil de mantener': 'An easier routine to maintain',
  'Sabor gummy que ayuda a la constancia': 'Gummy flavor that supports consistency',
  'Mas simple que varios frascos': 'Simpler than several bottles',
  'Un formato diario pensado para acompanarte en mananas ocupadas, con una experiencia simple para toda la familia.': 'A daily format designed to support busy mornings, with a simple experience for the whole family.',
  'Una opcion practica para convertir el apoyo nutricional en un habito diario facil de recordar.': 'A practical option to turn nutritional support into an easy-to-remember daily habit.',
  'Una presentacion clara para reunir ingredientes seleccionados en una sola rutina diaria.': 'A clear presentation to bring selected ingredients into one daily routine.',
  'Resena editable de cliente': 'Editable customer review',
